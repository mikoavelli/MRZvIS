...
class ImageReconstructorNN:
    ...
    def train(self, inputs, targets, config):
        ...
        print(f"Starting Pure SGD (One chunk update). Total chunks: {num_chunks}, LR: {current_lr}")
        ...
        for epoch in range(max_epochs):
            ...
            for i in indices:
                ...
                loss = self.train_step(single_chunk_in, single_chunk_target, current_lr, compute_loss=True)
            ...
            if epoch % log_frequency == 0:
                print(f'Epoch {epoch}, Total SSE Loss: {epoch_loss_accum:.2f}, LR: {current_lr:.8f}')
